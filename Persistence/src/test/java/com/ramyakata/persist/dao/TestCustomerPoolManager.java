...
public class TestCustomerPoolManager extends TestCase {

	private CustomerPoolManager customerObj = null;
...
//	private String file = "src/main/resources/config.csv";
	...
	/**
	 * public void testGetallCustomers() { try { CustomerInput inObj6 = new
	 * CustomerInput(); inObj6.setFirstName("Vaishnavi");
	 * inObj6.setLastName("Manga"); inObj6.setEmailAddress("vaishmanga@gmail.com");
	 * inObj6.setDate(LocalDate.of(2024, 12, 12)); inObj6.setRate(3);
	 * inObj6.setCustomerID(106); CustomerInput inObj7 = new CustomerInput();
	 * inObj7.setFirstName("Kavya"); inObj7.setLastName("Inampudi");
	 * inObj7.setEmailAddress("kavyaInampud@gmail.com");
	 * inObj7.setDate(LocalDate.of(2024, 12, 4)); inObj7.setRate(3);
	 * inObj7.setCustomerID(107); try { // Add customer
	 * customerObj.addCustomer(inObj6); customerObj.addCustomer(inObj7);
	 * 
	 * // ExpectedResult // Initialize the expected result with the correct size
	 * (currentIndex) CustomerOutput[] expResult = new CustomerOutput[2];
	 * 
	 * expResult[0] = new CustomerOutput(); expResult[0].setFirstName("Vaishnavi");
	 ...
	 * 
	 * expResult[1] = new CustomerOutput(); expResult[1].setFirstName("Kavya");
	 ...
	 * assertEquals(expResult[i].getRate(), actResult[i].getRate()); }
	 * 
	 * } catch (CustomerException e) { System.out.println("CustomerException caught:
	 * " + e.getMessage()); } } catch (CustomerException e) {
	 * System.out.println("CustomerException caught: " + e.getMessage()); } }
	 **/
	...
	/**
	 * public void testSortCustomers() { try { CustomerInput inObj1 = new
	 * CustomerInput(); inObj1.setFirstName("prathhyu");
	 * inObj1.setLastName("potru"); inObj1.setEmailAddress("pratyuPotru@gmail.com");
	 * inObj1.setDate(LocalDate.of(2024, 7, 04)); inObj1.setCustomerID(109);
	 * inObj1.setRate(4);
	 * 
	 * CustomerInput inObj2 = new CustomerInput(); inObj2.setFirstName("lachi");
	 * inObj2.setLastName("sri"); inObj2.setEmailAddress("srilachi@gmail.com");
	 * inObj2.setDate(LocalDate.of(2024, 2, 14)); inObj2.setRate(4);
	 * inObj2.setCustomerID(110);
	 * 
	 * CustomerInput inObj3 = new CustomerInput(); inObj3.setFirstName("jishnu");
	 * inObj3.setLastName("mainedi");
	 * inObj3.setEmailAddress("jishnuminedi@gmail.com");
	 * inObj3.setDate(LocalDate.of(2024, 4, 19)); inObj3.setRate(4);
	 * inObj3.setCustomerID(111);
	 * 
	 * // Add customers customerObj.addCustomer(inObj1);
	 * customerObj.addCustomer(inObj2); customerObj.addCustomer(inObj3);
	 * 
	 * // Expected result after sorting by date CustomerOutput[] expResult = new
	 * CustomerOutput[3];
	 * 
	 * expResult[0] = new CustomerOutput(); expResult[0].setFirstName("lachi");
	 * expResult[0].setLastName("sri"); expResult[0].setgmail("srilachi@gmail.com");
	 * expResult[0].setDate(LocalDate.of(2024, 2, 14));
	 * expResult[0].setCustomerID(110); expResult[0].setRate(4);
	 * 
	 * expResult[1] = new CustomerOutput(); expResult[1].setFirstName("jishnu");
	 * expResult[1].setLastName("mainedi");
	 * expResult[1].setgmail("jishnuminedi@gmail.com");
	 * expResult[1].setDate(LocalDate.of(2024, 4, 19));
	 * expResult[1].setCustomerID(111); expResult[1].setRate(4);
	 * 
	 * expResult[2] = new CustomerOutput(); expResult[2].setFirstName("prathhyu");
	 * expResult[2].setLastName("potru");
	 * expResult[2].setgmail("pratyuPotru@gmail.com");
	 * expResult[2].setDate(LocalDate.of(2024, 7, 04));
	 * expResult[2].setCustomerID(109); expResult[2].setRate(4);
	 * 
	 * // Get actual result CustomerOutput[] actResult =
	 * customerObj.sortCustomers();
	 * 
	 * // Assert results for (int i = 0; i < expResult.length; i++) {
	 * assertEquals(expResult[i].getCustomerID(), actResult[i].getCustomerID());
	 * assertEquals(expResult[i].getFirstName(), actResult[i].getFirstName());
	 * assertEquals(expResult[i].getLatName(), actResult[i].getLatName());
	 * assertEquals(expResult[i].getGmail(), actResult[i].getGmail());
	 * assertEquals(expResult[i].getDate(), actResult[i].getDate());
	 * assertEquals(expResult[i].getRate(), actResult[i].getRate()); } } catch
	 * (CustomerException e) { System.out.println("CustomerException caught: " +
	 * e.getMessage()); } }
	 * 
	 * public void testRemoveCustomer() { try { CustomerInput inObj1 = new
	 * CustomerInput(); inObj1.setFirstName("shankar");
	 * inObj1.setLastName("jammala");
	 * inObj1.setEmailAddress("shankarjammala@gmail.com");
	 * inObj1.setDate(LocalDate.of(2024, 4, 7)); inObj1.setRate(4);
	 * inObj1.setCustomerID(112); CustomerInput inObj2 = new CustomerInput();
	 * inObj2.setFirstName("taehyung"); inObj2.setLastName("v");
	 * inObj2.setEmailAddress("taehyung@gmail.com");
	 * inObj2.setDate(LocalDate.of(2024, 12, 30)); inObj2.setRate(4);
	 * inObj2.setCustomerID(113);
	 * 
	 * // Add customers customerObj.addCustomer(inObj1);
	 * customerObj.addCustomer(inObj2);
	 * 
	 * // Expected result CustomerOutput[] expResult = new CustomerOutput[1];
	 * 
	 * expResult[0] = new CustomerOutput(); expResult[0].setFirstName("taehyung");
	 * expResult[0].setLastName("v"); expResult[0].setgmail("taehyung@gmail.com");
	 * expResult[0].setDate(LocalDate.of(2024, 12, 30));
	 * expResult[0].setCustomerID(113); expResult[0].setRate(4);
	 * 
	 * // Remove customer customerObj.removeCustomer(112);
	 * 
	 * // Get actual result CustomerOutput[] actResult =
